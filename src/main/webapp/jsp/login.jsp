...
<form action="../weather/login">
      ...
      <div class="links"> <a href="/jsp/forget_password.jsp">Forgot Password</a> <a href="/jsp/signup.jsp">Signup</a> 
...
<% String message = (String)request.getAttribute("msg");%>
      ...
      <%if(message != null){%> 
      <div id = "message" class="toast-container position-fixed bottom-0 end-0 p-3">
